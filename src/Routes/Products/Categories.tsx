                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col">
                                                        <div className="d-flex justify-content-center my-3">
                                                            ...
                                                            <button type="button" className="btn btn-danger" data-bs-toggle="modal" data-bs-target={`#delete-${record.category_id}`}><i className="bi bi-trash3 fs-6"></i> Delete</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
